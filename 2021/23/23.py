...
mincache = {}
def searchGraph(state, weights, dest):
    ...
    if string in mincache:
        ...
        for nstate, cost in getConnections(state, weights):
            steptotal = cost
            if nstate != dest:
                branchtotal = searchGraph(nstate, weights, dest)
...
print(searchGraph(startState, weights, endState))
print(djikstra(startState, dictToString(endState)))

##2
weights = makeWeights(4)
startState = fromLists(["c", "d", "d", "c"], ["b", "c", "b", "d"], ["a", "b", "a", "a"], ["d", "a", "c", "b"])
endState = fromLists(["a", "a", "a", "a"], ["b", "b", "b", "b"], ["c", "c", "c", "c"], ["d", "d", "d", "d"])
print(searchGraph(startState, weights, endState))
print(djikstra(startState, dictToString(endState)))